...
| [DecreaseAmountItem](./reduce-amount-item.md)             | Decreases the item amount from the player's hand or inventory.                                                                                                                                |
...
| [ClearEnchantmentItem](./clear-enchantment-item.md)       | Clears all enchantments from the item.                                                                                                                                                        |
...
| [SetCustomModelDataItem](./set-custom-model-data-item.md) | Sets the custom model data of the item for resource pack usage.                                                                                                                               |
